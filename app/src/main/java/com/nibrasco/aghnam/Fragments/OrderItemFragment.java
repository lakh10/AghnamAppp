...
import com.nibrasco.aghnam.Utils.RecyclerItemAdapter;
import com.nibrasco.aghnam.Utils.RecyclerItemTouchListener;
...
public class OrderItemFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(com.nibrasco.aghnam.R.layout.fragment_orderitem, container, false);
    }
    ...
    private void LinkControls(View v)
    {
        ...
        itemsView = (RecyclerView) v.findViewById(com.nibrasco.aghnam.R.id.recyclerItems);
    }
                ...
                new RecyclerItemTouchListener(getActivity().getApplicationContext(), itemsView, new RecyclerItemTouchListener.ClickListener() {
                    ...
                    public void onClick(View view, int position) {
                        ...
                        if (fragment != null) {
                            ...
                            ft.replace(com.nibrasco.aghnam.R.id.orderItemContentFrame, fragment);
                            ft.commit();
                        }
                    }
